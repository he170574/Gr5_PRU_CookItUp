...
Welcome to Cook It Up! This repository contains the source code and assets for our game. It is built using `Unity`.
...
"Cook It Up" encapsulates the joy of culinary artistry in a digital realm, offering a delightful and engaging gaming experience where every dish prepared is a step closer to culinary fame.

## Unity Version

This project was developed using `Unity`. Make sure you have the appropriate version of Unity installed to ensure a smooth experience when working with or running the project.

## Trailer & Demo

- [Youtube - Trailer Cook It Up]()

- [Youtube - Demo Cook It Up]()
